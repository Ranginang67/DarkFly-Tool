...
untuk men update tools ini tinggal lakukan install ulang saja caranya seperti pertama install tools darkfly, dengan melakukan install ulang, file yang lama akan di hapus dan di ganti dengan yang baru di install
